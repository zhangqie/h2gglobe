#include "../interface/TwoDStatAnalysis.h"
#include "Sorters.h"
...
// ----------------------------------------------------------------------------------------------------
TwoDStatAnalysis::TwoDStatAnalysis()  :
    name_("TwoDStatAnalysis")
{
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::Term(LoopAll& l)
{
    ...
    //l.rooContainer->FitToData2D("data_2D_model"+postfix, "data_mass_mvan", "data_mass", "data_mvan");  // Fit to full range of dataset


    MVATransfFile->Close(); //JTao
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::Init(LoopAll& l)
{
    if(PADEBUG)
        cout << "InitRealTwoDStatAnalysis START"<<endl;

    //===Added by JTao====
    MVATransfFile = TFile::Open("aux/Moriond13_FromMVAToMVAn.root");
    ...
    //cout<<"JTao: nEta_cat - "<<nEtaCategories<<" nR9_cat -- "<<nR9Categories<<" nPt_cat -- "<<nPtCategories<<endl;
    ...
    //cout<<"JTao-- Tot cat : "<<nCategories_<<" inc_cat: "<<nInclusiveCategories_<<" vbf_lepton_met_cat: "<<nVBFCategories+nVHhadCategories+nVHlepCategories+nVHmetCategories<<endl;
...
//    nCategories_=(nInclusiveCategories_+nVBFCategories+nVHhadCategories+nVHlepCategories);
    ...
    l.rooContainer->AddObservable("CMS_hgg_mvan" , mvanMin, mvanMax); //JTao
    ...
    //cout<<"JTao -- size of bkgPolOrderByCat: "<<bkgPolOrderByCat.size()<<endl;

    if( bkgPolOrderByCat.empty() ) {
      //cout<<"JTao -- I am in bkgPolOrderByCat initianization with cats : "<<nCategories_<<endl;
    ...
    // build the model
    buildBkgModel(l, postfix); ///2d Model
    ...
    l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan", "data_mass_mvan", nDataBins, nMVANBins); // (100,110,150) -> for a window, else full obs range is taken
    l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan", "bkg_mass_mvan" , nDataBins, nMVANBins);
	...
	int sig = sigPointsToBook[isig];
        ...
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_ggh_mass_m%d",sig),nDataBins, nMVANBins);
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_vbf_mass_m%d",sig),nDataBins, nMVANBins);
        if(!splitwzh) l.rooContainer->CreateDataSet2D("CMS_hgg_mass","CMS_hgg_mvan",Form("sig_mass_mvan_wzh_mass_m%d",sig),nDataBins, nMVANBins);
        else{
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_wh_mass_m%d",sig),nDataBins, nMVANBins);
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_zh_mass_m%d",sig),nDataBins, nMVANBins);
        }
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_tth_mass_m%d",sig),nDataBins, nMVANBins);

        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_ggh_mass_m%d_rv",sig),nDataBins, nMVANBins);
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_vbf_mass_m%d_rv",sig),nDataBins, nMVANBins);
        if(!splitwzh) l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_wzh_mass_m%d_rv",sig),nDataBins, nMVANBins);
        else{
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_wh_mass_m%d_rv",sig),nDataBins, nMVANBins);
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_zh_mass_m%d_rv",sig),nDataBins, nMVANBins);
        }
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_tth_mass_m%d_rv",sig),nDataBins, nMVANBins);

        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_ggh_mass_m%d_wv",sig),nDataBins, nMVANBins);
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_vbf_mass_m%d_wv",sig),nDataBins, nMVANBins);
        if(!splitwzh) l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_wzh_mass_m%d_wv",sig),nDataBins, nMVANBins);
        else{
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_wh_mass_m%d_wv",sig),nDataBins, nMVANBins);
            l.rooContainer->CreateDataSet2D("CMS_hgg_mass","CMS_hgg_mvan",Form("sig_mass_mvan_zh_mass_m%d_wv",sig),nDataBins, nMVANBins);
        }
        l.rooContainer->CreateDataSet2D("CMS_hgg_mass", "CMS_hgg_mvan",Form("sig_mass_mvan_tth_mass_m%d_wv",sig),nDataBins, nMVANBins);
    }
    ...
    */
    ...
    if(PADEBUG)
        cout << "InitRealTwoDStatAnalysis END"<<endl;
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::buildBkgModel(LoopAll& l, const std::string & postfix)
{
    ...
    //JTao
    l.rooContainer->AddRealVar("CMS_hgg_mass_pow_0"+postfix,-6.0,-10.0,0.0);
    l.rooContainer->AddRealVar("CMS_hgg_mass_pow_1"+postfix, 6.0, 0.0,10.0);
    l.rooContainer->AddRealVar("CMS_hgg_mass_pow_2"+postfix,-5.0,-10.0,0.0);
    l.rooContainer->AddFormulaVar("CMS_hgg_mass_pow_0"+postfix,"@0*@0","CMS_hgg_mass_pow_0"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mass_pow_1"+postfix,"@0*@0","CMS_hgg_mass_pow_1"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mass_pow_2"+postfix,"@0*@0","CMS_hgg_mass_pow_2"+postfix);

    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_0"+postfix,-2.0, -5.0,  0.0);
    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_1"+postfix, 4.0,  0.0,  10.0);
    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_2"+postfix,-2.0, -5.0,  0.0);
    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_3"+postfix,-3.0, -5.0,  0.0);
    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_4"+postfix, 5.0,  0.0,  10.0);
    l.rooContainer->AddRealVar("CMS_hgg_mvan_pol6_5"+postfix,-2.0, -5.0,  0.0);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_0"+postfix,"@0*@0","CMS_hgg_mvan_pol6_0"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_1"+postfix,"@0*@0","CMS_hgg_mvan_pol6_1"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_2"+postfix,"@0*@0","CMS_hgg_mvan_pol6_2"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_3"+postfix,"@0*@0","CMS_hgg_mvan_pol6_3"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_4"+postfix,"@0*@0","CMS_hgg_mvan_pol6_4"+postfix);
    l.rooContainer->AddFormulaVar("CMS_hgg_mvan_pol_5"+postfix,"@0*@0","CMS_hgg_mvan_pol6_5"+postfix);
    ...
    */
	...
	int catmodelmass = 3;  //power function, the slope is related to mvan
	for(int iorder = 0; iorder<catmodelmass; ++iorder) {
	  catpars.push_back( Form( "CMS_hgg_mass_pow_%d%s", iorder, +postfix.c_str() ) );
	}
	int catmodelmvan= 6; //6 poly function to fit the mvan shape
	for(int iorder = 0; iorder<catmodelmvan; ++iorder) {
	  catpars.push_back( Form( "CMS_hgg_mvan_pol_%d%s", iorder, +postfix.c_str() ) );
	}
      } else if ( catmodel != -1 ) {
   ...
   // now loop over the models and allocate the pdfs
	...
	l.rooContainer->AddSpecificCategoryPdf2D(&catflags[0],"data_2D_model"+postfix,
						 "0","CMS_hgg_mass", "CMS_hgg_mvan",catpars, catpars.size(), 1.0, 1.0, 1.0);
      }else{
        cout<<"JTao -- You are using wrong model !!!"<<endl;
    ...
    //l.rooContainer->AddSpecificCategoryPdf2D(&catflags[0],"data_2D_model"+postfix,
    //					     "0","CMS_hgg_mvan", "CMS_hgg_mvan",catpars, catpars.size(), 1.0, 1.0, 1.0);
...
// ----------------------------------------------------------------------------------------------------
bool TwoDStatAnalysis::Analysis(LoopAll& l, Int_t jentry)
{
    if(PADEBUG)
...
bool TwoDStatAnalysis::AnalyseEvent(LoopAll& l, Int_t jentry, float weight, TLorentzVector & gP4,
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::FillRooContainer(LoopAll& l, int cur_type, float mass, float diphotonMVA,
				    int category, float weight, bool isCorrectVertex, int diphoton_id)
{


      TString histname="TransformMVAtoMVAn";
      TGraph* mvatransgp = (TGraph*)MVATransfFile->Get(histname);
      float mvan = mvatransgp->Eval(diphotonMVA);
    ...
    if (cur_type == 0 ) {
      ...
      //l.rooContainer->InputDataPoint2D("data_mass_mvan", "data_mass","data_mvan", category,mass,mvan, 1.0);
      l.rooContainer->InputDataPoint2D("data_mass_mvan", category,mass,mvan, 1.0);
    } else if (cur_type > 0 ) {
      if( doMcOptimization ) {
	//l.rooContainer->InputDataPoint2D("data_mass_mvan", "data_mass","data_mvan",category,mass,mvan,weight);
	l.rooContainer->InputDataPoint2D("data_mass_mvan",category,mass,mvan,weight);
      } else {
	//l.rooContainer->InputDataPoint2D("bkg_mass_mvan", "bkg_mass","bkg_mvan",category,mass,mvan,weight);
	l.rooContainer->InputDataPoint2D("bkg_mass_mvan", category,mass,mvan,weight);
      }
    } else if (cur_type < 0) {
      l.rooContainer->InputDataPoint2D("sig_mass_mvan_"+GetSignalLabel(cur_type, l),category,mass,mvan,weight);
      if (isCorrectVertex) l.rooContainer->InputDataPoint2D("sig_mass_mvan_"+GetSignalLabel(cur_type, l)+"_rv",category,mass,mvan,weight);
      else l.rooContainer->InputDataPoint2D("sig_mass_mvan_"+GetSignalLabel(cur_type, l)+"_wv",category,mass,mvan,weight);
    }
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::AccumulateSyst(int cur_type, float mass, float diphotonMVA,
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::FillRooContainerSyst(LoopAll& l, const std::string &name, int cur_type,
					...
					std::vector<int>    & categories, std::vector<double> & weights, int diphoton_id)
{
	...
	l.rooContainer->InputSystematicSet("sig_mass_mvan_"+GetSignalLabel(cur_type, l),name,categories,mass_errors,weights);
    }
}

// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::computeExclusiveCategory(LoopAll & l, int & category, std::pair<int,int> diphoton_index, float pt, float diphobdt_output)
{
    if(VHmuevent) {
...
int TwoDStatAnalysis::categoryFromBoundaries(std::vector<float> & v, float val)
{
    if( val == v[0] ) { return 0; }
...
int TwoDStatAnalysis::categoryFromBoundaries2D(std::vector<float> & v1, std::vector<float> & v2, std::vector<float> & v3, float val1, float val2, float val3 )
{
...
void TwoDStatAnalysis::fillControlPlots(const TLorentzVector & lead_p4, const  TLorentzVector & sublead_p4, const TLorentzVector & Higgs,
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::fillSignalEfficiencyPlots(float weight, LoopAll & l)
{
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::GetBranches(TTree *t, std::set<TBranch *>& s )
{
...
// ----------------------------------------------------------------------------------------------------
bool TwoDStatAnalysis::SelectEvents(LoopAll& l, int jentry)
{
    return true;
}
// ----------------------------------------------------------------------------------------------------
double TwoDStatAnalysis::GetDifferentialKfactor(double gPT, int Mass)
{
    return 1.0;
}

void TwoDStatAnalysis::FillSignalLabelMap(LoopAll & l)
{
...
std::string TwoDStatAnalysis::GetSignalLabel(int id, LoopAll &l){
...
void TwoDStatAnalysis::rescaleClusterVariables(LoopAll &l){
...
void TwoDStatAnalysis::ResetAnalysis(){
...
void TwoDStatAnalysis::fillOpTree(LoopAll& l, const TLorentzVector & lead_p4, const TLorentzVector & sublead_p4, Float_t vtxProb,
...
// ----------------------------------------------------------------------------------------------------
int TwoDStatAnalysis::GetBDTBoundaryCategory(float bdtout, bool isEB, bool VBFevent){
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::fillZeeControlPlots(const TLorentzVector & lead_p4, const  TLorentzVector & sublead_p4,
...
// ----------------------------------------------------------------------------------------------------
void TwoDStatAnalysis::fillEscaleTree(const TLorentzVector & lead_p4, const  TLorentzVector & sublead_p4,
                           const TLorentzVector & Higgs, float lead_r9, float sublead_r9,
                           float phoid_mvaout_lead, float phoid_mvaout_sublead,
                           float diphobdt_output, float sigmaMrv, float sigmaMwv, float vtxProb,
                           int diphoton_id, int category, int selectioncategory, float evweight, LoopAll & l )
